...
{
    public interface IDomainServiceBase<TKey, TViewModel>
        where TViewModel : class, IBaseViewModel<TKey>
    {
        ...
        //  Remove
        void Remove(TViewModel viewModel, bool applyPhysical = false);
        void RemoveRange(IEnumerable<TViewModel> viewModels, bool applyPhysical = false);

        void Remove(TKey viewModelId, bool applyPhysical = false);
        void RemoveRange(IEnumerable<TKey> viewModelIds, bool applyPhysical = false);
