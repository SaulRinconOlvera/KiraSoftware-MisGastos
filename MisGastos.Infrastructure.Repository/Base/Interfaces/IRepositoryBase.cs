...
namespace MisGastos.Infrastructure.Repository.Base.Interfaces
{
        ...
        where TEntity : class, IBaseEntity<TKey>
    {
        ...
        //  Remove
        void Remove(TEntity entity, bool applyPhysical = false, bool autoSave = true);
        void RemoveRange(IEnumerable<TEntity> entities, bool applyPhysical = false, bool autoSave = true);

        void Remove(TKey entityId, bool applyPhysical = false, bool autoSave = true);
        void RemoveRange(IEnumerable<TKey> entitiesIds, bool applyPhysical = false, bool autoSave = true);
